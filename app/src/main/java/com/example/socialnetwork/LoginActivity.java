...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView NeedNewAccountLink, resetPassowrdLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetPassowrdLink = (TextView) findViewById(R.id.forget_password_link);

        mAuth = FirebaseAuth.getInstance();

        resetPassowrdLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, ResetPassowrdActivity.class));
            }
        });
    ...
    //add validation to make app more secure
    @Override
    ...
    private void VerifyEmailAddress(){
        ...
        if(emailAddressChecker){
            ...
            Toast.makeText(this, "Please verify your acount first....." , Toast.LENGTH_SHORT).show();
            mAuth.signOut();
        }
